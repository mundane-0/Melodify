...
<!-- TODO: Add actual screenshots of the Melodify application.
Example:

![Melodify Main Interface](screenshots/main-interface.png)

![Melodify Analysis View](screenshots/analysis-view.png)
-->
